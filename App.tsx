...
const App = () => {
  ...
  return (
    <div className="flex items-start justify-center gap-6 w-full transition-all duration-500 ease-out">
      {/* Main Calculator */}
      ...
      >
        <div className="w-96 bg-surface-1 rounded-2xl border border-surface-3 shadow-card dark:shadow-card-dark overflow-hidden">
          {/* Panel Header */}
          <div className="flex justify-between items-center p-4 border-b border-surface-3">
            ...
            <button 
              ...
              className="p-1 rounded-md hover:bg-surface-2 transition-colors text-text-muted hover:text-text-primary"
            >
          ...
          <div className="p-4 space-y-5 max-h-[calc(100vh-200px)] overflow-y-auto">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-semibold text-text-primary font-display">What is this calculator?</h3>
              </div>
              <p className="text-xs text-text-secondary leading-relaxed font-display">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-semibold text-text-primary font-display">Using the Lock Icons</h3>
              </div>
              <p className="text-xs text-text-secondary leading-relaxed font-display">
                Click the lock icon next to an input to fix the value. 
              </p>
              <div className="flex gap-2 mt-2">
                <div className="flex-1 p-2 bg-surface-2 rounded-lg border border-surface-3">
                  <div className="flex items-center gap-1.5 mb-1">
                    <svg className="w-3.5 h-3.5 text-text-muted" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                    </svg>
                    <span className="text-xs font-medium text-text-primary font-display">Locked</span>
                  </div>
                  <p className="text-[10px] text-text-muted font-display">Auto-calculated</p>
                </div>
                <div className="flex-1 p-2 bg-surface-2 rounded-lg border border-surface-3">
                  <div className="flex items-center gap-1.5 mb-1">
                    <svg className="w-3.5 h-3.5 text-brand-pink" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M8 11V7a4 4 0 118 0m-4 8v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2z" />
                    </svg>
                    <span className="text-xs font-medium text-text-primary font-display">Unlocked</span>
                  </div>
                  <p className="text-[10px] text-text-muted font-display">User Input</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-semibold text-text-primary font-display">The Boost Slider</h3>
              </div>
              <p className="text-xs text-text-secondary leading-relaxed font-display">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-semibold text-text-primary font-display">Unlock Both Values</h3>
              </div>
              <p className="text-xs text-text-secondary leading-relaxed font-display">
              ...
              <div className="mt-2 p-3 bg-brand-pink/5 rounded-lg border border-brand-pink/20">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-semibold text-text-primary font-display">System Totals</h3>
              </div>
              <p className="text-xs text-text-secondary leading-relaxed font-display">
